...
def main(_):
    ...
    # cfg['train_dataset']='./data/trian/ms1m_kface_bin.tfrecord'
    cfg['test_dataset']='./data/test/'
    cfg['num_samples']=5872144
    cfg['num_classes']=86144
    ...
    if cfg['train_dataset']:
        logging.info("load ms1m kface dataset.")
